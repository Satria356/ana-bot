...
kagura.sendMessage(from, { sticker : buff}) 
}
break
case 'apakah':
...
if (!Number(text)) reply(`Example : ${prefix + command} 6283811034750`)
...
const templateMessage = {
text: 'Chat P Tidak Akan Di Balas',footer: `© ${ownername}`,
templateButtons: [
{
index: 1, 
urlButton: {
...
case 'menu': {
if(typemenu == 'allmenu'){
await kagura.send5ButImg(from, `` + '' + lang.menu(botname, pushname, salam, ownername, time, tanggal), `WHATSAPP BOT MULTI DEVICE`,thumb, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Github`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Sewa","id": 'donate'}}] )
}
if(typemenu == 'simple'){
await kagura.send5ButImg(from, `` + '' + lang.menusimpel(botname, pushname, salam, ownername, time, tanggal), `WHATSAPP BOT MULTI DEVICE`,thumb, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Github`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Sewa","id": 'donate'}}] )
}
}
break
case 'menu1':
